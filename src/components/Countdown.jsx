	...
	return (
		<section className="m-auto mt-10 flex min-h-[160px] max-w-[1200px] flex-col bg-primary lg:flex-row">
			<div className="relative">
				<img
					className=" h-[260px] w-full object-cover opacity-50 lg:w-[1200px]"
					...
					alt=""
				/>
				<div className="absolute top-20 flex w-full flex-col items-center gap-4 p-4  lg:w-[1200px]">
					<h3 className="font-cursive text-5xl text-primary md:text-[80px] lg:text-[100px] ">
